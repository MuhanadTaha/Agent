<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="myHome.aspx.cs" Inherits="myHome" EnableEventValidation="false"  %>
 ...
 <div class="col-lg-6 styleDiv" >
  ...
  <img class="mySlides" src="images/ImageWebsite/2.jpg" style="width:100%; height:380px">
     ...
     <div class="col-lg-3 styleDiv text-center">
         <div class="styleDiv2">
          <asp:Label ID="lblHello" runat="server" Text="" style="text-transform: capitalize" CssClass="f-20"></asp:Label>
            <br />
               <asp:DropDownList ID="ddlPermession" runat="server" style="height:35px;"></asp:DropDownList>
                <asp:Button ID="btnRequests" runat="server" Text="Add Requests" CssClass="btn btn-primary btn-sm" OnClick="btnRequests_Click" />
